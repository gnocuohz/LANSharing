...
public class ChangeNickNameMsg implements BaseMsg{
	...
	public ChangeNickNameMsg(UserInfo info) {
		super();
		this.info = info;
	}
	
	public ChangeNickNameMsg(byte[] message) {
	...
	public byte[] toBytes() {
		...
		try {
			...
			byte_msgType = BytesUtil.intToByteArray(BaseRequest.MSG_TYPE_CHANGENICKNAME);
