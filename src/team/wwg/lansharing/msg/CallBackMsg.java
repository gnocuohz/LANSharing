...
public class CallBackMsg implements BaseMsg{
	...
	public CallBackMsg(UserInfo info) {
		super();
		this.info = info;
	}
	
	public CallBackMsg(byte[] message) {
	...
	public byte[] toBytes() {
		...
		try {
			...
			byte_msgType = BytesUtil.intToByteArray(BaseRequest.MSG_TYPE_LOGIN_CALLBACK);
