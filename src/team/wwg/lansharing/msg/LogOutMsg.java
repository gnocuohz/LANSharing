...
public class LogOutMsg implements BaseMsg {
	...
	public LogOutMsg(UserInfo info) {
		super();
		this.info = info;
	}
	
	public LogOutMsg(byte[] message) {
	...
	public byte[] toBytes() {
		...
		try {
			...
			byte_msgType = BytesUtil.intToByteArray(BaseRequest.MSG_TYPE_LOGOUT);
